...
SECRET_KEY = 'django-insecure-v1k8^#l$kaweg)2_ril^tdm%10u5)roj6-s$r1ay^v%ctao#xr'
...
AUTH_USER_MODEL='register_login.userRegistration'
...
STATIC_URL = '/softwareProjectstatic/'
MEDIA_URL='/images/'
